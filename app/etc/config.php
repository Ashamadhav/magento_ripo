...
return [
    'modules' => [
        ...
        'Temando_Shipping' => 1,
        'Terrificmind_Faq' => 1,
        'Terrificminds_AdminGrid' => 0,
        'Terrificminds_AroundPlugin' => 0,
        'Terrificminds_CartPlugin' => 0,
        'Terrificminds_PreferenceName' => 0,
        'Terrificminds_PreferencePrice' => 0,
        'Terrificminds_PricePlugin' => 0,
        'Terrificminds_ProductVideos' => 1,
        'Tm_Checkout' => 0,
        'Vertex_Tax' => 1,
